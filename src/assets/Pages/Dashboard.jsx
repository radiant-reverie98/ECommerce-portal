        ...
        <div className="w-full max-w-7xl overflow-x-auto bg-[#1E293B] shadow-xl rounded-xl p-6">
          ...
          <table className="min-w-full table-auto border-collapse text-white">
            <thead className="bg-[#334155]">
              <tr>
                {['Item ID', 'Product Name', 'Price', 'Quantity', 'Actions'].map((heading, index) => (
                  <th
                    key={index}
              ...
              {products.length > 0 ? (
                products.map((product, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm border-b border-[#334155]">{product.product_title}</td>
                    <td className="px-6 py-4 text-sm border-b border-[#334155]">₹{product.selling_price}</td>
